 ...
 return (
   <div className="page-single-treatment">
     ...
     <h2 className="h2-single-treatment">
       הכוח המרגיע והמאזן של טיפול בצלילים מרפאים, חוויה רוחנית ייחודית המשתמשת בצלילים מהדהדים מכלי נגינה עתיקים כדי לאזן את זרימת האנרגיה בגוף ולהעניק תחושה עמוקה של רגיעה ושלווה.
     </h2>
