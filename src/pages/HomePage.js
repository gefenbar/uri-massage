    ...
    <div className="about-content">
      ...
      <div className="about-text-container">
        ...
        <p>
          ...
          אני מבצע מגוון טיפולים, ביניהם: טיפול בצלילים מרפאים טיפול בצלילים מרפאים (Sound Healing),  עיסוי שוודי, עיסוי לנשים בהריון, עיסוי תינוקות, טיפול בקריסטלים ועוד.
        </p>
